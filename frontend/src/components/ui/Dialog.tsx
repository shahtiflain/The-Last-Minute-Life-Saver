  ...
  return (
    <dialog
      ...
      className={cn(
        ...
        "w-[calc(100vw-2rem)] sm:w-full sm:max-w-lg max-h-[85vh]",
        className
      )}
    >
      <div className="flex flex-col w-full h-full max-h-[85vh]">
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-border-color/50 sticky top-0 bg-transparent z-10">
